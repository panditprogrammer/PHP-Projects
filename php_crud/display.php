...
<head>
    ...
    <title>Users data : php_crud</title>
</head>
            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    <ul class="navbar-nav">
                        ...
                        <li class="nav-item">
                            <a href="insert.php" class="nav-link active">Show all Records</a>
                        </li>
        ...
        <table class="table table-striped table-hover table-bordered">
            ...
            ?>
                ...
                <tr class="text-center">
                    ...
                    <td>
                        <a href="update.php?id= <?php echo $result['id'] ?>" class="btn btn-secondary">Update</a>
                    </td>
