...
<body>
    ...
    <div class="container">
        <h3 class="m-4 text-center">Update your details </h3>
        <!-- for security we have to use htmlspecialchars -->
        <form class="row " method="POST">
            <div class="col-md-6 m-auto my-2">
                <label for="username" class="form-label">Name</label>
                <input type="text" class="form-control" id="username" name="username" value=" <?php echo $result['name']; ?>">
            </div>
            <div class="col-md-6 m-auto my-2">
            ...
            <div class="col-md-6 m-auto my-2">
                ...
                <input type="text" class="form-control" id="degree" name="degree" value="<?php echo $result['degree']; ?>">
            </div>
            <div class="col-md-6 m-auto my-2">
                <label for="language" class="form-label">Language</label>
                <input type="text" class="form-control" id="language" name="language" value="<?php echo $result['language']; ?>">
            </div>
            <div class="col-md-6 m-auto my-2">
            ...
            <div class="col-md-6 m-auto my-2">
                ...
                <input type="text" class="form-control" id="address" placeholder="1234 Main St.US" name="address" value=" <?php echo $result['address']; ?>">
            </div>
...
if (isset($_POST['submit'])) {
    ...
    if ($username === "" || $email === "" || $degree === "" || $address === "" || $language === "" || $password === "") {
        ...
        $sql = "UPDATE `register` SET `id`='$id',`name`='$username',`email`='$email',`degree`='$degree',`address`='$address',`language`='$language',`password`='$password' WHERE `id` = $id";
